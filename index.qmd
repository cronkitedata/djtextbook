...
This book serves as a compilation of of handouts, websites and tutorials that I have created in my data reporting class at ASU's [Cronkite School of Journalism and Mass Communication](https://cronkite.asu.edu), IRE and NICAR conferences, and as an adjunct at the Columbia University Graduate School of Journalism. Some of the material will be useful in other courses or for self-study, but it is primarily aimed at the investigative journalism masters' students at Cronkite.
...
Generally, when Windows users see the key `cmd` or {{< kbd CMD >}}, they should use `ctl` or `^` instead; when you see {{< kbd OPT >}}, use {{< kbd ALT >}} instead.

Keyboard combinations are generally shown like this: `CMD + SHIFT + i` , where the + indicates the keys at once, such as {{< kbd cmd-Shift-i >}} or {{< kbd Control-Shift-i >}} 

### Conventions used in tutorials {.unnumbered}
...
This book was written using Quarto version 1.3 in RStudio with version 4.3 of R. . The complete source is [available on Github](https://github.com/cronkitedata/djtextbook). Previous editions are saved as branches in the github repo, and also saved as static releases.
...
-- Sarah Cohen, Winter 2023-24 [sarah.h.cohen\@asu.edu](mailto:sarah.h.cohen@asu.edu)
