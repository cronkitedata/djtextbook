...
>
> -- [Social Media: Where voices of hate find a place to preach](https://hateinamerica.news21.com/social-media-where-hate-finds-place-to-preach), News 21, August 2018
...
*[Google data search](https://toolbox.google.com/datasetsearch)** is, well, the Google of data. In general, data search has limited sources and is more and more frequently logging datasets that are posted by state and local government sources.
